...
test-tsan:
	...
	clang $(CFLAGS_TSAN) $(INCLUDES) -I tests/ -I src/              \
	    tests/run_tests.c tests/test_layer1.c tests/test_layer2.c tests/test_layer3.c tests/test_layer4.c $(LIB_TSAN) $(LDFLAGS) \
	    -o $(TEST_BIN_TSAN)
...
$(TEST_BIN): $(LIB_DEV) tests/run_tests.c tests/test_layer1.c tests/test_layer2.c tests/test_layer3.c tests/test_layer4.c tests/test_harness.h
	@mkdir -p $(BUILD_TESTS_DIR)
	$(CC) $(CFLAGS_DEV) $(INCLUDES) -I tests/ -I src/		\
	    tests/run_tests.c tests/test_layer1.c tests/test_layer2.c tests/test_layer3.c tests/test_layer4.c $(LIB_DEV) $(LDFLAGS)	\
	    -o $(TEST_BIN)

# --- Valgrind test binary (no sanitizers) -----------------------------------

$(TEST_BIN_VG): $(LIB_VG) tests/run_tests.c tests/test_layer1.c tests/test_layer2.c tests/test_layer3.c tests/test_layer4.c tests/test_harness.h
	@mkdir -p $(BUILD_TESTS_DIR)
	$(CC) $(CFLAGS_VG) $(INCLUDES) -I tests/ -I src/		\
	    tests/run_tests.c tests/test_layer1.c tests/test_layer2.c tests/test_layer3.c tests/test_layer4.c $(LIB_VG) $(LDFLAGS)	\
	    -o $(TEST_BIN_VG)
